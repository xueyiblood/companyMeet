...
import com.yuanch.common.annotation.Excels;
...
public class ExcelUtil<T>
{
            ...
            for (int i = 1; i < rows; i++)
            {
                ...
                for (Map.Entry<Integer, Field> entry : fieldsMap.entrySet())
                {
                    ...
                    if (StringHelper.isNotNull(fieldType))
                    {
                        ...
                        {
                            val = reverseByExp(ConvertUtils.toStr(val), attr.readConverterExp());
                        }
    ...
    public Cell addCell(Excel attr, Row row, T vo, Field field, int column)
    {
        ...
        try
        {
            ...
            if (attr.isExport())
            {
                ...
                {
                    cell.setCellValue(convertByExp(ConvertUtils.toStr(value), readConverterExp));
                }
                else
                {
                    // 设置列类型
    ...
    {
        String downloadPath = YuanChConfig.getDownloadPath() + filename;
